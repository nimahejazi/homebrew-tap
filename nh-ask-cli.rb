class NhAskCli < Formula
  ...
  url "https://github.com/nimahejazi/ask/archive/refs/tags/v0.2.15.tar.gz"
  sha256 "194f46680a403d1cc7e6292a86a9217e4e3f89b7662c7910178e9cc77b2f0bd3"
  license "MIT"

  depends_on "python-setuptools" => :build
  depends_on "python@3.12"

  # --- top-level runtime deps (from requirements.txt) ---
  resource "tomli" do
  ...
  # --- transitive deps (required by requests, questionary, rich above) ---
